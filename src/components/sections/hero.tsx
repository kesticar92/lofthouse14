...
export function Hero() {
    ...
    return (
        <>
            <section id="inicio" className="h-screen w-full overflow-hidden flex flex-col justify-end relative">
                {/* Video Background */}
                ...
                <div className="z-10 w-full p-6 pb-12 md:p-16 md:pb-20">
                    <div className="text-left max-w-3xl">
                        ...
                        <p className="text-lg md:text-xl text-gray-200 mt-4 drop-shadow-md">
                            Hospedaje moderno, seguro y cerca de <br className="hidden md:block" />
