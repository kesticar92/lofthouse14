...
const timelineData = [
  ...
  },
  {
    ...
    title: "Capacidad",
    date: "Paso 03",
    content: "Nuestro sistema valida la mejor opción para tu grupo al instante.",
    category: "Reserva",
    icon: CheckSquare,
    relatedIds: [2, 4],
...
export function RadialOrbitalTimelineDemo() {
  return (
    <section id="proceso" className="py-12 px-4 md:py-20 md:px-20 relative overflow-hidden bg-white dark:bg-[#0a0a0a]">
      ...
      <div className="max-w-6xl mx-auto px-4 mb-12 text-center relative z-10">
        ...
        <h2 className="font-display text-4xl md:text-6xl tracking-tight text-zinc-900 dark:text-[#f2f0eb]">
          CÓMO <span className="text-amber-600 dark:text-amber-500">RESERVAR</span>
        </h2>
        <p className="mt-6 text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
          Sigue estos sencillos pasos para asegurar tu estancia en LoftHouse. 
          Un proceso diseñado para tu comodidad y seguridad.
        </p>
      </div>
