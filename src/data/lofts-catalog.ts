...
> = {
  ...
  "02": {
    ...
    description:
      "El Loft 02 combina un interior moderno con la ubicación que más buscan quienes preguntan por hotel cerca del Parque del Perro en Cali: estás en Miraflores, no en un corredor hotelero genérico. Es un apartaestudio con cocina equipada, aire acondicionado y WiFi para videollamadas o streaming después de caminar por la zona. Ideal para 2 personas y con cupo de hasta 5 si viajas con familia pequeña. Desde aquí llegas a pie a gastronomía, salsa y servicios; el Estadio Pascual Guerrero y San Antonio quedan a un trayecto corto en transporte. Reservar directo con Lofthouse 14 evita comisiones de plataformas y te da un interlocutor local por WhatsApp para fechas, anticipo e ingreso autónomo. La tarifa base es la misma del resto de lofts individuales: desde $90.000 COP por noche en temporada baja para dos huéspedes, con aseo según duración de la estadía.",
  },
  "03": {
  ...
  "08": {
    ...
    description:
      "El Loft 08 es un loft en Cali para pareja: un solo espacio privado, cama, baño, cocina y aire acondicionado para volver después de salsa, una cena en el Parque del Perro o un día en San Antonio. Miraflores concentra la oferta gastronómica que buscas cuando preguntas dónde hospedarse en Cali, Colombia, sin alejarte de la vida del centro-sur. Capacidad ideal 2; si viaja un tercero, aplica recargo. Check-in autónomo, anticipo del 50% y saldo el día de llegada. Desde $90.000 COP por noche en temporada baja. No se permiten fiestas; el edificio es residencial y el silencio nocturno se respeta. Si celebras un cumpleaños íntimo, avísanos: podemos orientar restaurantes cercanos, no un evento en el loft. Reserva directo en lofthouse14.com o WhatsApp +57 318 158 5801 para ver fechas reales y no una tarifa opaca de OTA.",
  },
  "09": {
  ...
  "14": {
    ...
    description:
      "El Loft 14 completa la oferta individual de Lofthouse 14: un apartaestudio en Miraflores, Cali, con WiFi, aire acondicionado, cocina, Smart TV y baño privado. Sirve a turistas, nómadas, pacientes y grupos que toman esta unidad junto a otras. Capacidad 2 ideal, 5 máximo. Precio desde $90.000 COP por noche en temporada baja. El nombre del proyecto coincide con esta unidad, pero todas las demás siguen el mismo estándar de check-in autónomo, anticipo 50% y reglas de convivencia. Estás a pasos del Parque del Perro y de San Fernando; el mapa de la página de ubicación marca restaurantes, cultura y ocio. Si necesitas la casa entera para hasta 63 personas, usa la ficha de grupos; si viajas solo o en pareja, este loft basta. WhatsApp +57 318 158 5801. Dirección: Carrera 26 # 2-91, Miraflores, Valle del Cauca, Colombia.",
  },
};
...
function loftUnit(code: string): LoftUnit {
  ...
  return {
    ...
    metaDescription: `${copy.shortDescription} Desde $90.000/noche. Check-in autónomo. Reserva directo.`,
