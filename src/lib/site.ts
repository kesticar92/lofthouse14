...
export const site = {
  ...
  maxGuestsPerLoft: 5,
  gallery: [
    "/gallery/immersive/09-fachada_diurna.webp",
    "/gallery/immersive/11-fachada_sillas_diurna.webp",
    "/gallery/immersive/10-fachada_nocturna.webp",
    "/gallery/immersive/06-corredor_salida.webp",
